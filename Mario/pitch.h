...
#define staccato_letter(note) note, NOTE_REST
...
#define _8th_NOTE          8
#define _16th_NOTE        16
#define _32nd_NOTE        32
#define _64th_NOTE        64
#define _128th_NOTE      128
#define triplet(note)   (3*note/2), (3*note/2), (3*note/2)
#define dotted(note)    (1/(1.5/(float)note))
#define staccato(note)  (note*2), (note*2) 
...
void setBarLine (unsigned int bpm, byte bpi, byte bn){
    beatsPerMinute = bpm;
    beatsPerMeasure = bpi;
    beatsPerNote = bn;
    millisPerNote = ((float)1000*60/beatsPerMinute)*beatsPerNote;
}
...
//#define EIGHTH_NOTE     0.125
//#define SIXTEENTH_NOTE  0.0625

//#define DOTTED_WHOLE_NOTE     1.5
//#define DOTTED_HALF_NOTE      0.75
//#define DOTTED_QUARTER_NOTE   0.375
//#define DOTTED_EIGHTH_NOTE    0.1875
//#define DOTTED_SIXTEENTH_NOTE 0.09375
