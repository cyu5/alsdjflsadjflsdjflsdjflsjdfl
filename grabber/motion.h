...
void accelMov (byte dir, unsigned long steps, unsigned int n=25*2, unsigned int startPeriod=1000*2, unsigned int startSteps=64/2){
...
void accelMovp2 (byte dir, unsigned long steps, unsigned char power = 2, unsigned int n=10*4, unsigned long startPeriod=(long)4000*16, unsigned char startSteps=1){
